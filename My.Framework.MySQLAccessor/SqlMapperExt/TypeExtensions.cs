...
namespace My.Framework.MySQLAccessor
{
    ...
    internal static class PropertyNameExtension
    {
        /// <summary>
        /// 属性名转列名
        /// </summary>
        /// <param name="propertyName">类的属性名</param>
        /// <returns>带下划线的列名 eg.UserName to user_name</returns>
        public static string ToColName(this string propertyName)
        {
            //Regex regex = new Regex("([a-z])([A-Z])");
            //return regex.Replace(propertyName, "$1_$2").ToLower();
            Regex regex = new Regex("([A-Z])");
            return regex.Replace(propertyName, "_$1").TrimStart('_').ToLower();
        }
    }
}