...
namespace My.Framework.MySQLAccessor
{
    public static partial class SqlMapperExtensions
    {
        ...
        public static async Task<bool> InsertAsync<T>(this IDbConnection connection, T entityToInsert, IDbTransaction transaction = null,
            int? commandTimeout = null, ISqlAdapter sqlAdapter = null) where T : class
        {
            ...
            {
                var row= sqlAdapter.Insert(connection, transaction, commandTimeout, name, sbColumnList.ToString(),
...
public partial class MySqlAdapter
{
        ...
        string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
    {
        ...
        var result = await connection.ExecuteAsync(cmd, entityToInsert, transaction, commandTimeout);
        var r = connection.Query<dynamic>("SELECT LAST_INSERT_ID() id", transaction: transaction, commandTimeout: commandTimeout);
